# 模型选择、欠拟合和过拟合：深度学习入门必读

> 本文是《动手学深度学习》第4章的学习笔记，详细讲解模型选择、欠拟合和过拟合的核心概念，配合代码演示，帮助你彻底理解这些重要的概念。
...
这些问题就是**欠拟合**和**过拟合**。本文将详细讲解这些概念，并通过代码演示帮助你理解。

---

## 🎯 目录

1. [核心概念：训练误差和泛化误差](#1-核心概念训练误差和泛化误差)
2. [三种情况：欠拟合、过拟合、刚刚好](#2-三种情况欠拟合过拟合刚刚好)
3. [模型选择：怎么选最好的模型](#3-模型选择怎么选最好的模型)
4. [K折交叉验证：数据少时的解决方案](#4-k折交叉验证数据少时的解决方案)
5. [模型复杂度和数据量的关系](#5-模型复杂度和数据量的关系)
6. [代码演示：完整示例](#6-代码演示完整示例)
7. [总结与实践建议](#7-总结与实践建议)
...
- [4.1 模型选择、欠拟合和过拟合](./underfit-overfit.ipynb)
